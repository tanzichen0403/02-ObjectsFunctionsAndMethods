...
def main():
    ...
    better_draw_circles(rg.Point(10, 50), 5)
    better_draw_circles(rg.Point(50, 150), 35)
    even_better_draw_circles(rg.Point(25,10),5,3,"red",7)
    even_better_draw_circles(rg.Point(-125, -30), 7, 8, "blue", 1)
    window.update()
...
def even_better_draw_circles(point,r,amo,color,thick):
