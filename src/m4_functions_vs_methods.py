...
def try_methods():
    ...
    ###########################################################################
    tan = rg.SimpleTurtle("turtle")
    tan.pen= rg.Pen("brown",5)
    tan.forward(150)
    tan.left(90)
    tan.forward(50)
    tan.backward(100)
...
def try_methods_and_functions():
    ...
    zi = rg.SimpleTurtle()
    zi.pen = rg.Pen("blue",5)
    zi.forward(150)
    zi.speed=1
    draw_many_squares(zi, 2, 100, 30)
    zi.speed=5
    zi.pen = rg.Pen('red',5)
    draw_many_squares(zi, 10, 50, 15)
    zi.speed=100
    zi.pen = rg.Pen('red',35)
    draw_many_squares(zi, 8, 300, 60)
    zi.pen=rg.Pen('black',3)
    zi.backward(200)
    zi.draw_circle(30)
    zi.draw_square(50)
# -----------------------------------------------------------------------------
